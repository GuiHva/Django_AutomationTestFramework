...
def add_event(request):
    ...
    result = Event.objects.name(name=name)
    if result:
...
def get_event_list(request):
    eid = request.GET.get("eid", "")  # Event ID
    name = request.GET.get("name", "")  # Event name
...
def add_guest(request):
    eid = request.POST.get('eid', '')  # Event id
    realname = request.POST.get('realname', '')  # name
    phone = request.POST.get('phone', '')  # phone
    email = request.POST.get('email', '')  # mail
